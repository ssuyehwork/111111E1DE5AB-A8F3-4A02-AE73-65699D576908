    ...
    : QDialog(parent, Qt::FramelessWindowHint | Qt::Window)
{
    ...
    m_btnPin->setIcon(UiHelper::getIcon("pin_tilted", QColor("#aaaaaa")));
    ...
    m_minBtn->setIcon(UiHelper::getIcon("minimize", QColor("#888888")));
    ...
    m_maxBtn->setIcon(UiHelper::getIcon("maximize", QColor("#888888")));
    ...
    m_closeBtn->setIcon(UiHelper::getIcon("close", QColor("#888888")));
...
void FramelessDialog::toggleStayOnTop(bool checked) {
    ...
    if (m_btnPin) {
        m_btnPin->setIcon(UiHelper::getIcon(checked ? "pin_vertical" : "pin_tilted", checked ? QColor("#FF551C") : QColor("#aaaaaa")));
    }
}
...
void FramelessDialog::toggleMaximize() {
    if (isMaximized()) {
        ...
        showMaximized();
        m_maxBtn->setIcon(UiHelper::getIcon("restore", QColor("#888888")));
...
void FramelessDialog::loadWindowSettings() {
    ...
    if (m_btnPin) {
        ...
        m_btnPin->setIcon(UiHelper::getIcon(stay ? "pin_vertical" : "pin_tilted", stay ? QColor("#FF551C") : QColor("#aaaaaa")));
