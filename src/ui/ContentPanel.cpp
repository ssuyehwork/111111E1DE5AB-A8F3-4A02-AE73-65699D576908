...
void ContentPanel::initListView() {
    ...
    m_treeView->setStyleSheet(
        ...
        "QTreeView::item { height: 28px; color: #EEEEEE; padding-left: 4px; border-radius: 4px; }"
...
void ContentPanel::onCustomContextMenuRequested(const QPoint& pos) {
    QMenu menu(this);
    menu.setStyleSheet(
        "QMenu { background-color: #2B2B2B; border: 1px solid #444444; color: #EEEEEE; padding: 4px; border-radius: 8px; }"
        "QMenu::item { height: 24px; padding: 0 10px 0 10px; border-radius: 4px; font-size: 12px; }"
