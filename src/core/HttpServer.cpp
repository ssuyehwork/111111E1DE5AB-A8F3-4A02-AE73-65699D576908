            ...
            if (dataBuffer.contains("POST /add_note") || dataBuffer.contains("POST /api/full/add") || 
                ...
                if (!doc.isNull() && doc.isObject()) {
                    ...
                    if (reqStr.contains("/add") || reqStr.contains("/add_note")) {
                        ...
                        int noteId = DatabaseManager::instance().addItem(title, content, tags, "", targetCatId, "text", QByteArray(), "Browser", pageTitle);
                    ...
                    if (reqStr.contains("/update")) {
                        ...
                        if (id > 0 && DatabaseManager::instance().updateItem(id, title, content, tags)) {
